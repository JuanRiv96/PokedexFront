      ...
      <body>
        <div className="w-full h-screen flex flex-col items-center justify-center">
          <svg className="w-1/2 md:w-1/3 lg:w-1/4 text-blue-600" 
            ...
            ry="38.5" 
            fill="#3f3d56"></ellipse><ellipse 
            cx="310.60911" cy="645.5" rx="170" ry="23.12721" 
            ...
            x="578.43291" y="212.68859" 
            width="513.25314" height="357.51989" 
            rx="18.04568" 
            fill="#2f2e41"></rect><rect 
            x="595.70294" y="231.77652" 
            width="478.71308" height="267.83694" 
            fill="#3f3d56"></rect><circle 
            cx="835.05948" cy="223.29299" r="3.02983" 
            fill="#f2f2f2"></circle><path 
            ...
            cx="1066.53846" cy="654.13477" rx="7.87756" ry="2.42386" 
            fill="#f2f2f2"></ellipse><circle 
            cx="835.05948" cy="545.66686" r="11.51335" 
            ...
            cx="300.60911" cy="643.5" rx="20" ry="7.5" 
            fill="#2f2e41"></ellipse><ellipse 
            cx="348.60911" cy="642.5" rx="20" ry="7.5" 
            fill="#2f2e41"></ellipse><circle 
            cx="318.60911" cy="518" r="27" 
            fill="#fff"></circle><circle 
            cx="318.60911" cy="518" r="9" 
            ...
            cx="417.21511" cy="611.34365" rx="39.5" ry="12.40027" 
            transform="translate(-238.28665 112.98044) rotate(-23.17116)" 
            fill="#2f2e41"></ellipse><ellipse 
            cx="269.21511" cy="664.34365" rx="39.5" ry="12.40027" 
          ...
          <div className="flex flex-col items-center justify-center">
              <p className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-wider text-white mt-8">500</p>
              <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mt-2">Server Error</p>
              <p className="md:text-lg xl:text-xl text-white mt-4">{ error.message }.</p>
          </div>
          <button className="text-black font-bold rounded-lg bg-white mt-3 w-20 h-10" onClick={() => reset()}>Try again</button>
        </div>
      </body>
    </html>
  )
